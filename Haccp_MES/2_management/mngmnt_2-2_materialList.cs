...
{
    public partial class mngmnt_2_2_materialList : Form
    {
        ...
        private void mngmnt_2_2_materialList_Load(object sender, EventArgs e)
        {
            conn.Open();

            string orderInfoHeadQuery = "SELECT mat_no, mat_name, mat_type, mat_spec, mat_price, mat_etc " + "" +
                "FROM info_material " + 
                "WHERE mat_type IN ('제품');";
        ...
        private void gridSelectInfoMaterial_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                ((mngmnt_2_1_insertData)(this.Owner)).childVal = gridSelectInfoMaterial.CurrentRow;
